...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      components: {
        default: () =>
          import(/* webpackChunkName: "search-stories" */ './views/Search.vue'),
      },
      meta: {
        isModalView: true,
      },
    ...
    // list my stories
    {
      ...
      components: {
        default: () =>
          import(
            /* webpackChunkName: "user-stories" */ './views/UserStoriesList.vue'
          ),
        footer: () =>
          import(/* webpackChunkName: "footer" */ './views/Footer.vue'),
      },
      meta: {
        isModalView: true,
      },
    },
    {
      ...
      components: {
        default: () =>
          import(
            /* webpackChunkName: "starred-stories" */ './views/Starred.vue'
          ),
      },
      meta: {
        isModalView: true,
    ...
    // create a story
    {
      ...
      components: {
        default: () =>
          import(
            /* webpackChunkName: "create-story" */ './views/CreateUpdateStory.vue'
          ),
        footer: () =>
          import(/* webpackChunkName: "footer" */ './views/Footer.vue'),
      },
    ...
    // view a story
    {
      ...
      beforeEnter: (to, from, next) => {
        const isModalView = from.matched.some(
          (view) => view.meta && view.meta.isModalView
        );
    ...
    // edit user profile
    {
      ...
      components: {
        default: () =>
          import(
            /* webpackChunkName: "edit-user" */ './views/UserProfileEdit.vue'
          ),
        footer: () =>
          import(/* webpackChunkName: "footer" */ './views/Footer.vue'),
      },
    ...
    // view / edit user settings
    {
      ...
      components: {
        default: () =>
          import(
            /* webpackChunkName: "user-settings" */ './views/Settings.vue'
          ),
        footer: () =>
          import(/* webpackChunkName: "footer" */ './views/Footer.vue'),
      },
    ...
    // validate email feedback
    {
      ...
      components: {
        default: () =>
          import(
            /* webpackChunkName: "validate-email" */ './views/ValidateEmail.vue'
          ),
        footer: () =>
          import(/* webpackChunkName: "footer" */ './views/Footer.vue'),
      },
    ...
    // validate email feedback
    {
      ...
      components: {
        default: () =>
          import(/* webpackChunkName: "validate-email" */ './views/Test.vue'),
      },
    },
    {
      path: '*',
