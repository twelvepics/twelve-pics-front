                ...
                <div class="message-body" style="padding-top:0;">
                    <div class="field">
                        <label class="label" :class="{ isError: $v.user.username.$error }">
                            Username:
                            <span class="content is-small" style="color:red;" v-if="$v.user.username.$error"
                    ...
                    <div class="field">
                        <label class="label" :class="{ isError: $v.user.email.$error }">
                            Email:
                            <span class="content is-small" style="color:red;" v-if="$v.user.email.$error"
                    ...
                    <div class="field">
                        <label class="label" :class="{ isError: $v.user.repeatPassword.$error }">
                            Confirm password:
                            <span class="content is-small" style="color:red;" v-if="$v.user.repeatPassword.$error"
