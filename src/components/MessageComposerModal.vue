                ...
                <div class="message-body">
                    ...
                    <div class="field">
                        <label class="label is-size-6 mt10">
                            Subject
                            <span class="content is-small" style="color:red;" v-if="$v.messageSubject.$error"
                    ...
                    <div class="field">
                        <label class="label is-size-6 mt10">
                            Your message
                            <span class="content is-small" style="color:red;" v-if="$v.messageBody.$error"
                    ...
                    <div class="field is-grouped submit-buttons">
                        ...
                        <div class="control">
                            <button class="button is-dark" @click.prevent="closeMessageModal" :disabled="done">
                                Cancel
                            </button>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            // console.log(message);
            try {
                await axiosBase.post(`/users/${this.authenticatedUser._key}/send-private-message`, {
                    type: message.type,
