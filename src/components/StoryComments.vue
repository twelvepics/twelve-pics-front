  ...
  -->
    <div class="card comments" style="margin-top:25px;">
        ...
        <div class="card-content">
            ...
            <p class="content">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore harum, facilis praesentium esse
                veritatis nemo!
            </p>
            <!-- ADD COMMENT FORM -->
            ...
            <div v-for="(comment, idx) in comments" :key="idx">
                ...
                <div class="comment-edit" v-if="comment_edit_idx === idx">
                    ...
                    <button class="button is-light is-small mt10p20 ml10" @click.prevent="cancelUpdateComment()">
                        Cancel
                    </button>
                </div>
                <!-- -->
