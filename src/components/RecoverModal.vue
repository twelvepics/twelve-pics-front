    ...
    <div class="modal-content">
      <form class="message" @submit.prevent="onSubmit" novalidate>
        ...
        <div class="message-body">
          <p
            v-if="initMessage && !$v.emailOrUsername.$error"
            style="font-size:85%"
          >Please enter your username down below in order to be able to get a new password.</p>
          <p
            v-if="found"
            style="font-size:85%;color:#0a61c5"
          >An email has been sent to the email address you provided during registration.</p>
          <p v-if="apiError" class="isError" style="font-size:85%">{{ errorMessage }}</p>
          <p
            v-if="$v.emailOrUsername.$error"
            class="isError"
            style="font-size:85%"
          >Enter your username or email address</p>
          <div class="field">
