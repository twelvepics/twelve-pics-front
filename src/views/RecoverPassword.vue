          ...
          <div class="card-content" v-else>
            <form @submit.prevent="onSubmit" novalidate>
              ...
              <p
                ...
                style="margin-bottom:0 !important"
              >Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore harum, facilis!</p>
              <!-- PASSWORD -->
              <div class="field" style="margin-top:20px;">
                <label class="label is-marginless">
                  ...
                  <span
                    class="content is-small"
                    style="color:red;"
                    v-else-if="apiErrors && apiErrors.hasOwnProperty('password') && apiErrors.password !== null"
              ...
              <div class="field" style="margin-top:20px;">
                <label class="label is-marginless">
                  ...
                  <span
                    class="content is-small"
                    style="color:red;"
                    v-else-if="apiErrors && apiErrors.hasOwnProperty('repeat_password') && apiErrors.repeat_password !== null"
                  >Password and password confirm don't match</span>
                </label>
                <div class="control" style="max-width: 500px;">
                  <input
