      ...
      <div class="column is-three-quarters-desktop">
        <div class="card">
          ...
          <div class="card-content" v-if="isError">
            <p
              class="title is-size-5 isError"
            >We couldn't confirm this email address. Please try again</p>
            <p class="subtitle is-size-6 isError">
              ...
              <span
                v-if="isAuthenticated && errorStatus===404 && confirmEmailSent"
