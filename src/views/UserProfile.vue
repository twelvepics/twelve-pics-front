        ...
        <div class="columns is-centered">
            ...
            <div class="column is-three-quarters-desktop">
                ...
                <div v-else-if="userCannotReceiveMessage && !is_loading" class="notification is-warning">
                    <b>{{ authenticatedUser && user && (user.profile.display_name || user.username) }}</b> did not
                    confirm his email address. You cannot message him. Sorry.
                </div>
...
export default {
    ...
    methods: {
        ...
        async sendConfirmEmail() {
            await axiosBase.post(`/users/${this.authenticatedUser._key}/send-confirm-email`);
    ...
    computed: {
        ...
        messagingEnabled: function() {
            return (
                this.isAuthenticated && this.authenticatedUser.email_confirmed && this.user && this.user.email_confirmed
            );
        },
        ...
        showEditButton: function() {
            return this.isAuthenticated && this.user._key === this.authenticatedUser._key;
        },
        ...
        hasLinks() {
            ...
            return !!(l.website || l.instagram || l.twitter || l.facebook || l.flickr);
        }
    },
    created() {
        this.fetchData();
